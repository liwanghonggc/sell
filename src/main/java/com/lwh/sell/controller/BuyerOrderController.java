...
import com.lwh.sell.converter.OrderFormToOrderDTOConverter;
...
import com.lwh.sell.vo.ResultVO;
...
public class BuyerOrderController {
    ...
    public ResultVO list(@RequestParam("openid") String openid,
        ...
        return ResultVO.ofSuccess(orderDTOPage.getContent());
    }
    ...
    public ResultVO detail(@RequestParam("openid") String openid,
        ...
        return ResultVO.ofSuccess(orderDTO);
    }
